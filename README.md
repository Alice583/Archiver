...
(Шестая лабораторная работа первого семестра ИТМО)

Программа: реализация помехоустойчивого архиватора файлов без сжатия **HamArc**, объединяющего несколько файлов в один архив.
Для помехоустойчивого кодирования используются [Коды Хэмминга](https://en.wikipedia.org/wiki/Hamming_code).
